...
function calculateBoundingBox (geoPoint) {
    let minlon = parseFloat((geoPoint[0] - 0.025).toFixed(7));
    let minlat = parseFloat((geoPoint[1] - 0.025).toFixed(7));

    let maxlon = parseFloat((geoPoint[0] + 0.025).toFixed(7));
    let maxlat = parseFloat((geoPoint[1] + 0.025).toFixed(7));
